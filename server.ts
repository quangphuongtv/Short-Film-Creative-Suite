...
// Endpoint 7: Save Storyboard into TypeScript source file format
app.post("/api/save-storyboard", async (req, res) => {
...
export const SAVED_PROJECT_DATA: SavedProjectData = {
  ...
  globalBrief: ${JSON.stringify(globalBrief || {
    title: '',
    genre: '',
    aspectRatio: '16:9',
